# -*- coding: utf-8 -*-
"""
Created on Wed Jul  1 10:58:12 2020
@author: 代码医生工作室
...
class NeighborSampler(object):
    def __init__(self, g, user_type, item_type, num_layers,random_walk_length= 2, 
                 random_walk_restart_prob = 0.5,
                 num_random_walks= 10, num_neighbors=3):
        self.g = g
        self.user_type = user_type
        self.item_type = item_type
        self.user_to_item_etype = list(g.metagraph[user_type][item_type])[0]
    ...
    def sample_blocks(self, seeds, heads=None, tails=None, neg_tails=None):
        ...
        for sampler in self.samplers:
            ...
            if heads is not None:
                ...
                if len(eids) > 0:  #使正负样本对独立。采样中不能含有正负样本对的边
    ...
    def sample_from_item_pairs(self, heads, tails, neg_tails):
        ...
        # print("1:",heads.numpy())
        # print("1:",tails.numpy())
        # print("1:",neg_tails.numpy())
        # print("1:",seeds.numpy() )
        # print("2:",set(heads.numpy().tolist()+ tails.numpy().tolist()+neg_tails.numpy().tolist()) )
        # print("1:", len(seeds.numpy()),
        #       len( set(heads.numpy().tolist()+ tails.numpy().tolist()+neg_tails.numpy().tolist()) ))
        # seeds2 = torch.cat([heads, tails,neg_tails]).unique()
        # print("3:", seeds2,len(seeds2))
